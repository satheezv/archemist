from archemist.state.stations.pxrd_analyser import pxrd_analyser
...
class pxrdSM():
    ...
    def __init__(self, args: dict):
        ...
        self.machine.add_transition('process_state_transitions', source='open_pxrddoors',dest='load_plate', conditions='is_station_job_ready')
        ...
        # re-open pxrd doors
        self.machine.add_transition('process_state_transitions',source='close_pxrddoors',dest='open_pxrddoors', conditions='is_station_job_ready')
        ...
        # close pxrd doors 
        self.machine.add_transition('process_state_transitions', source='unload_plate',dest='close_pxrddoors', conditions='is_station_job_ready')
